...
QUEFTS_point <- function(siteSoilNutrient,
                   ad,
                   nutrients_kg.ha) { 
  ...
  NPUPT <- nutrientUPT_point(SN, a[1], r[1], d[1], SP, a[2], r[2], d[2])
  NKUPT <- nutrientUPT_point(SN, a[1], r[1], d[1], SK, a[3], r[3], d[3])
  PNUPT <- nutrientUPT_point(SP, a[2], r[2], d[2], SN, a[1], r[1], d[1])
  PKUPT <- nutrientUPT_point(SP, a[2], r[2], d[2], SK, a[3], r[3], d[3])
  KNUPT <- nutrientUPT_point(SK, a[3], r[3], d[3], SN, a[1], r[1], d[1])
  KPUPT <- nutrientUPT_point(SK, a[3], r[3], d[3], SP, a[2], r[2], d[2])
  ...
  YNP <- combine_yields_point(UN, a[1], d[1], r[1], YaP, YdP, YdK, Yatt)
  YNK <- combine_yields_point(UN, a[1], d[1], r[1], YaK, YdK, YdP, Yatt)
  YPN <- combine_yields_point(UP, a[2], d[2], r[2], YaN, YdN, YdK, Yatt)
  YPK <- combine_yields_point(UP, a[2], d[2], r[2], YaK, YdK, YdN, Yatt)
  YKN <- combine_yields_point(UK, a[3], d[3], r[3], YaN, YdN, YdP, Yatt)
  YKP <- combine_yields_point(UK, a[3], d[3], r[3], YaP, YdP, YdN, Yatt)
